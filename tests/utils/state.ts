...
import {BeaconState, Crosslink, Eth1Data, Fork, PendingAttestation, uint64, Validator, Slot, number64, Epoch, Shard, BeaconBlockHeader} from "../../src/types";
...
import { intToBytes } from "../../src/chain/helpers/stateTransitionHelpers";
